            ...
            <div class="modal-body">
                <form id="product_info" class="horizontal-form">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input class="input-md textinput textInput form-control" id="product_image" style="margin-bottom: 10px" type="file" multiple/>
                        </div> 
                    </div>    
    ...
    <table id="product_list" class="table table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right"><?php echo $value['groupNum']; ?></td>    
                <td class="text-right"><?php echo $value['groupPrice']; ?></td>    
                <td class="text-right"><?php echo $value['groupTime']; ?></td>         
                <td style="width:10%">
